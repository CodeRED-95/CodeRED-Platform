...
- Busqueda de DNI por nombres: contrato features en /auth/me y flujo AJAX del proveedor
...
- update.sh ya no aborta al comprobar la tabla transitoria ruc_records_next
...
- update.sh ya no aborta cuando el token de Declaracion Jurada esta al dia
...
- Consulta de DNI por nombres y apellidos con proveedor DNIPERU
...
- Solicitud de acceso desde cualquier cliente y aviso a revisores
...
- Canal de actualizacion de CodeRED Desktop
...
- profile:read como ability base de todo token
...
- Entrega real del OTP y fin del error sin correo
...
- API de administración para CodeRED Mobile: tokens, solicitudes de token y usuarios, con ability por área y permiso RBAC por acción. Aprobar y rechazar comparten implementación con el panel web
