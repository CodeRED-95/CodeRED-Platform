    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/70" x-cloak>
        <div class="w-full max-w-2xl rounded-2xl border border-amber-500/30 bg-gradient-to-b from-amber-50 to-white p-8 shadow-2xl dark:from-amber-950/20 dark:to-slate-900">
            ...
            <div class="mb-6 flex items-center justify-between">
                ...
                <button wire:click="closeProtectedData" class="text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200">
            ...
            <div class="flex justify-end gap-3">
                <button wire:click="closeProtectedData" class="px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800">
                    Cerrar
                </button>
            </div>
        </div>
