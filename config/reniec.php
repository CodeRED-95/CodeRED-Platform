...
return [
    ...
    'incoming_directory' => preg_replace('#^private/#', '', (string) env('RENIEC_IMPORT_INCOMING_DIRECTORY', 'private/reniec/incoming')),
    'working_directory' => preg_replace('#^private/#', '', (string) env('RENIEC_IMPORT_WORKING_DIRECTORY', 'private/reniec/working')),
    'archive_directory' => preg_replace('#^private/#', '', (string) env('RENIEC_IMPORT_ARCHIVE_DIRECTORY', 'private/reniec/archive')),
    'errors_directory' => preg_replace('#^private/#', '', (string) env('RENIEC_IMPORT_ERRORS_DIRECTORY', 'private/reniec/errors')),
