...
return [
    ...
    'mobile_rate_limit_per_minute' => (int) env('API_MOBILE_RATE_LIMIT_PER_MINUTE', 15),
    ...
    'abilities' => [
        ...
        'admin:solicitudes' => 'Administración · Solicitudes de token',
        'admin:usuarios' => 'Administración · Usuarios',
        'shalom-recordar:sync' => 'Sincronizar Shalom Recordar',
        'shalom-recordar:read-own' => 'Consultar sincronizaciones propias de Shalom Recordar',
    ],
];
