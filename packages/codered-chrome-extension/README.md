...
El content script busca encabezados compatibles como `.mdl-layout__header-row`, inyecta una sola vez `#mi-buscador-contenedor` y usa `MutationObserver` con control de frecuencia para reinyecciones por navegacion dinamica.
