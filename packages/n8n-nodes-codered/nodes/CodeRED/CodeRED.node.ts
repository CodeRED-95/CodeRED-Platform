...
async function runOperation(this: IExecuteFunctions, c: CodeREDCredentials, op: string, i: number): Promise<any> {
  if (op === 'pairInstance') {
    ...
    return this.helpers.httpRequest({ method: 'POST', url: joinUrl(c.baseUrl, '/api/v1/integrations/n8n/pair'), body, headers: { 'Content-Type': 'application/json' }, json: true, timeout: 10000 });
  }
