...
class ConnectionManager {
    ...
    async connect(input) {
        return this.request('POST', '/api/v1/pair', { pair_code: input.pairCode, instance_name: this.credentials.instanceName, instance_url: this.credentials.publicUrl, version: process.env.N8N_VERSION || undefined, environment: this.credentials.environment });
    }
    async disconnect() { return this.request('POST', '/api/v1/disconnect'); }
    async rotateSecret() { return this.request('POST', '/api/v1/rotate-secret'); }
