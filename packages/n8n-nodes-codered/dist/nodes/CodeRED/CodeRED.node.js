...
async function runOperation(c, op, i) {
    if (op === 'pairInstance') {
        ...
        return this.helpers.httpRequest({ method: 'POST', url: (0, GenericFunctions_1.joinUrl)(c.baseUrl, '/api/v1/integrations/n8n/pair'), body, headers: { 'Content-Type': 'application/json' }, json: true, timeout: 10000 });
    }
    const map = {
